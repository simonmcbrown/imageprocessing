...
# It is odd but "red (2% + 6%)" produces darker VDens than max_cyan (18%).  This must be the epson driver doing somthin odd with what it knows about the coloured inks.  So what do we do.  I think the most sensible is to progress from 2%(Y) to 6%(M) to 2%x+6%(R) to 6%x+18% (Blue) to 18%x+100%
